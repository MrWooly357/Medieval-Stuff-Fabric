...
public final class AlternativesSpawnEntry extends LeafSpawnEntry {
    ...
    protected List<Entity> createEntities(SpawnContext context) {
        for (SpawnEntry entry : entries) {
            List<Entity> entities = entry.generateEntities(context);
    ...
    public static final class Builder extends LeafSpawnEntry.Builder<Builder> {
        ...
        public AlternativesSpawnEntry build(SpawnSelector.Data data, SpawnPosFinder posFinder) {
            return new AlternativesSpawnEntry(List.copyOf(entries), data, List.copyOf(conditions), posFinder, ignoreVanillaRules, List.copyOf(rules), List.copyOf(functions));
        }
